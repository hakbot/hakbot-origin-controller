 ...
 *       &lt;sequence>
 *         &lt;element name="PingServiceResult" type="{http://ntobjectives.com/webservices/}Result"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PingServiceResponse {
    ...
    @XmlElement(name = "PingServiceResult", required = true)
    protected Result pingServiceResult;
     ...
     *     
     */
    public Result getPingServiceResult() {
     ...
     *     
     */
    public void setPingServiceResult(Result value) {
